<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav" style="padding-top: 20px;">
      ...
      <li class="nav-item">
        <a class="nav-link " href="health.ht">
