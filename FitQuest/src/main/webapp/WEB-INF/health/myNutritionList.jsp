		...
		$.ajax({
			...
			success : function (data) {
				...
				// 데이터정보가 있을 때
					...
					msgAll += '<li style="width: 25%">칼로리' + allSumCal.toFixed(2) + 'kcal</li>';
					msgAll += '<li style="width: 25%">탄수화물 ' + allSumBo.toFixed(2) + 'g</li>';
					msgAll += '<li style="width: 25%">단백질 ' + allSumPro.toFixed(2) + 'g</li>';
					msgAll += '<li style="width: 25%">지방 ' + allSumFat.toFixed(2) + 'g</li>';
					msgAll += '</ul></nav><hr><nav class="navbar"><ul style="width: 100%; text-align: center;">';
					msgAll += '<li style="width: 50%">당 ' + allSumSu.toFixed(2) + 'g</li>';
					msgAll += '<li style="width: 50%">나트륨 ' + allSumSo.toFixed(2) + 'mg</li>';
