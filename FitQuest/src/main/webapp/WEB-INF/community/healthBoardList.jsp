...
<body style="background-color: #FEF9E7; text-align: center;">
	<div class="title-container">
		<div class="title-text">건강 정보 게시판</div>
	</div>
	<main>
		<div class="card" style="width: 70%; margin: auto;">
			<div class="card-body">
				...
				<div class="col-md-12" align="center" style="margin-bottom: 20px; border-bottom: 1px solid lightgray; padding-bottom: 15px;">  
					<button id="button1" onClick="window.location.href='healthBoardList.co?&pageNumber=1&whatColumn=${ param.whatColumn }&keyword=${ param.keyword}'" class="title-button">
						전체
					</button>
					<button id="button2" onClick="window.location.href='healthBoardList.co?bcategory=운동&pageNumber=1&whatColumn=${ param.whatColumn }&keyword=${ param.keyword }'" class="title-button">
						운동
					</button>
					<button id="button3" onClick="window.location.href='healthBoardList.co?bcategory=식단&pageNumber=1&whatColumn=${ param.whatColumn }&keyword=${ param.keyword }'" class="title-button">
						식단
					</button>
					<button id="button4" onClick="window.location.href='healthBoardList.co?bcategory=기타&pageNumber=1&whatColumn=${ param.whatColumn }&keyword=${ param.keyword }'" class="title-button" style="margin-right: 0;">
						기타
					</button>
				 </div>
						...
						<c:forEach var="board" items="${ hotHealthBoardList }" varStatus="status">
							<tr align="center" >
								...
								<td align="left" style="background-color: #FEF9E7">
									<a style="color : black; font-weight: bold;" href="healthBoardDetail.co?bnum=${ board.bnum }">${ board.bsubject }</a>
								</td>
				...
				<div class="col-md-6" style="width: 100%; margin-top: 50px;">
			      <form method="get" class="search-form d-flex align-items-center" action="healthBoardList.co" style="justify-content: center;">
				      <c:if test="${ bcategory != '' }">
