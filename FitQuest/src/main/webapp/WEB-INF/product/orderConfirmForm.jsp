          ...
          <div class="col-lg-12 entries">
   			<article class="entry entry-single">
   			 <div class="col-lg-12">
			        ...
			        <div class="col-lg-12 col-sm-12 hero-feature">
			            <form action = "cartCalculate.pd" name = "myform">
			            ...
			            <div class="btn-group btns-cart">
			                ...
			                <button type="button" class="btn btn-warning" onClick = "location.href='cartList.pd'"><i class="fa fa-arrow-circle-left"></i>장바구니 보기</button>
