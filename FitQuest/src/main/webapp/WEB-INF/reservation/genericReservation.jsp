   ...
   <div class="changeCalendar">
    ...
    <div>
   	<c:forEach var="titem" items="${tsList}">
   		...
   		<c:forEach var="tstime" items="${fn:split(titem.tstime, ',')}">
   			<div>${tstime}토</div>
   			<div>${titem.tstype}</div>
		</c:forEach>
   		</c:if>
