		...
		<div class="card-body">
			<table class="table table-hover">
				...
				<c:if test="${not empty tList}">
					<c:forEach var="treservation" items="${tList}">
						<tr align="center">
							<td>
								<a href="#" onclick="openPopup('${treservation.rnum}','${treservation.rstate}')">
									${treservation.rdate}
								</a>
							</td>
							<td>${treservation.rtime}</td>
							<td>${treservation.tname}</td>
						</tr>
					</c:forEach>		
				</c:if>
		...
		<div class="card-body">
			<table  class="table table-hover">
				...
				<c:if test="${not empty fList}">
					<c:forEach var="freservation" items="${fList}">
						<tr align="center">
							<td>
								<a href="#" onclick="openPopup('${freservation.rnum}','${freservation.rstate}')">
									${freservation.rdate}
								</a>
							</td>
							<td>${freservation.rtime}</td>
							<td>${freservation.tname}</td>
						</tr>
					</c:forEach>		
				</c:if>
		...
		<div class="card-body">
			<table  class="table table-hover">
				...
				<c:if test="${not empty jList}">
					<c:forEach var="jreservation" items="${jList}">
						<tr align="center">
							<td>
								<a href="#" onclick="openPopup('${jreservation.rnum}','${jreservation.rstate}')">
									${jreservation.rdate}
								</a>
							</td>
							<td>${jreservation.rtime}</td>
							<td>${jreservation.tname}</td>
						</tr>
					</c:forEach>		
				</c:if>
		...
		<div class="card-body">
			<table  class="table table-hover">
				...
				<c:if test="${not empty cList}">
					<c:forEach var="creservation" items="${cList}">
						<tr align="center">
							<td>
								<a href="#" onclick="openPopup('${creservation.rnum}','${creservation.rstate}')">
									${creservation.rdate}
								</a>
							</td>
							<td>${creservation.rtime}</td>
							<td>${creservation.tname}</td>
						</tr>
					</c:forEach>		
				</c:if>
		...
		<div class="card-body">
			<table  class="table table-hover">
				...
				<c:if test="${not empty mList}">
					<c:forEach var="mreservation" items="${mList}">
						<tr align="center">
							<td>
								<a href="#" onclick="openPopup('${mreservation.rnum}','${mreservation.rstate}')">
									${mreservation.rdate}
								</a>
							</td>
							<td>${mreservation.rtime}</td>
							<td>${mreservation.tname}</td>
						</tr>
					</c:forEach>		
				</c:if>
